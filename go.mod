...
require (
	...
	github.com/cloudwego/eino-ext/components/model/agenticark v0.2.3 // indirect
	github.com/cloudwego/eino-ext/components/model/agenticopenai v0.2.1 // indirect
