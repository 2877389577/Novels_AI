...
type Novel struct {
	gorm.Model
	Title        string         `gorm:"column:title;type:varchar(255);not null" json:"title"`             // 小说标题
	...
	ChapterCount int            `gorm:"column:chapter_count;not null;default:0" json:"chapterCount"`      // 小说章节数
